...
<!--            </div>-->
            ...
            <div class="subheader">
                <h1 class="subheader-title">
                    <i class='subheader-icon fal fa-users'></i> User's list
                </h1>
            </div>
            <div class="row">
                <div class="col-xl-12">
                    <?php if($auth->hasAllRoles("1") ):?>
                    <a class="btn btn-success" href="/create">Add</a>
<?php endif;?>
                    <div class="border-faded bg-faded p-3 mb-g d-flex mt-3">
                        <input type="text" id="js-filter-contacts" name="filter-contacts" class="form-control shadow-inset-2 form-control-lg" placeholder="Find user">
            ...
            <div class="row" id="js-contacts">
                ...
                <div class="col-xl-4">
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags=" <?php echo $user['first_name'].' '. $user['last_name'] ?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <?php else:?>
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('uploads/<?php
                                    echo $user['image'] ?>'); background-size: cover;"></span>
                                <?php endif;?>
                                ...
                                <?php
                                        if($auth->hasAllRoles("1") || $user['id'] == $auth->id()):?>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="/status?id=<?php echo $user['id'];?>">
                                            <i class="fa fa-sun"></i>
                                        Set Status</a>
                                        <a class="dropdown-item" href="/medias?id=<?php echo $user['id'];?>">
                                    ...
                                    <?php echo $user['job'].', '.$user['company']?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                ...
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> <?php echo $user['user_address']?></address>
